...
articleView.handleAuthorFilter = function() {
  $('#author-filter').on('change', function() {
    ...
    if ($(this).val()) {
      ...
      $('article').hide();
      $(`article[data-author='${$(this).val()}']`).fadeIn(animationTiming);
      ...
      $('article').fadeIn(animationTiming);
      $('.template').hide();
    }
    $('#category-filter').val('');
  });
...
articleView.handleCategoryFilter = function() {
  ...
  $('#category-filter').on('change', function() {
    if ($(this).val()) {
      $('article').hide();
      $(`article[data-category='${$(this).val()}']`).fadeIn(animationTiming);
...
articleView.handleMainNav = function() {
  ...
  $('li.tab').on('click', function(){
    $('.tab-content').hide();
    $('#' + $(this).data('content')).fadeIn(animationTiming);
  });
...
articleView.setTeasers = function() {
  ...
  $('#articles').on('click', '.read-on', function(event){
    ...
    ($(this).prev().children()).fadeIn(animationTiming);
    $(this).hide();
  })
};
